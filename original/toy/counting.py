...
class Counter(nn.Module):
    ...
    def forward(self, boxes, attention):
        ...
        输入attention weight 和boxes的坐标， 输出count feature,box 是候选框的坐标集合。
        ...
        # 利用公式1将attention转换成邻接矩阵, 公式1: A = a * a.T，其中a为attention weight, *为矩阵乘
    ...
    def deduplicate(self, dedup_score, att):
        # using outer-diffs, 公式4，求出两个proposal 之间的相似度
